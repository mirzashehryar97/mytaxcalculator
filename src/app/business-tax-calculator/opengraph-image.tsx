  ...
  return new ImageResponse(
    ...
    >
      <div style={{ display: 'flex', flexDirection: 'column' }}>
        ...
        >
          {BUSINESS_SOCIAL_IMAGE_COPY.eyebrow}
        </div>
        <div
          style={{
            display: 'flex',
        ...
        >
          {BUSINESS_SOCIAL_IMAGE_COPY.title}
        </div>
        <div
          style={{
            color: '#a7f3d0',
        ...
        >
          {BUSINESS_SOCIAL_IMAGE_COPY.subtitle}
        </div>
      </div>
      ...
      >
        <div style={{ color: '#d1fae5', display: 'flex', fontSize: 23 }}>
          {BUSINESS_SOCIAL_IMAGE_COPY.features}
        </div>
        <div style={{ display: 'flex', fontSize: 25, fontWeight: 800 }}>
          {BUSINESS_SOCIAL_IMAGE_COPY.brand}
        </div>
      </div>
    </div>,
    size,
