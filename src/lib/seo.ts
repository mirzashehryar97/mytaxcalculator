...
export const SITE_KEYWORDS = [
  ...
  'vehicle tax calculator Pakistan',
  'car registration tax calculator Pakistan',
  'token tax calculator Pakistan',
  'Section 231B advance tax vehicle',
  'property purchase tax calculator Pakistan',
  'property sale tax calculator Pakistan',
  'capital gains tax calculator Pakistan property',
  'Section 236K tax calculator',
  'Section 236C tax calculator',
  'cash withdrawal tax calculator Pakistan',
  'tax on cash withdrawal Pakistan 231AB',
  'electricity bill tax calculator Pakistan',
  'Section 235 electricity advance tax',
  'mobile load tax calculator Pakistan',
  'Section 236 mobile internet tax',
  'corporate tax calculator Pakistan',
  'company tax rate Pakistan 2026-27',
  'minimum tax on turnover calculator Pakistan',
  'Section 113 minimum tax',
  'super tax calculator Pakistan',
  'Section 4C super tax',
  'agricultural income tax calculator Pakistan',
  'agriculture tax Punjab 2026-27',
  'farm income tax Pakistan',
...
export const routeMeta: Record<string, RouteMeta> = {
  ...
  '/corporate-tax-calculator': {
    title: 'Corporate Tax Calculator Pakistan 2026-27 | Company Rates',
    description:
      'Calculate Pakistan company income tax for FY 2026-27. Normal company 29%, small company 20% and banking 42%, for tax years 2022-23 through 2026-27.',
    breadcrumb: 'Corporate Tax Calculator',
    appendSiteName: false,
    keywords: [
      'corporate tax calculator Pakistan',
      'company tax calculator Pakistan',
      'corporate tax rate Pakistan 2026-27',
      'Pvt Ltd company tax calculator Pakistan',
      'small company tax rate Pakistan 20%',
      'banking company tax rate Pakistan 42%',
      'company income tax rate 29% Pakistan',
      'FBR corporate tax rates 2026-2027',
      'private limited company tax Pakistan',
      'corporate income tax Pakistan Division II',
    ],
    datePublished: '2026-07-30',
    dateModified: '2026-07-31',
    socialImage: '/corporate-tax-calculator/opengraph-image',
    socialImageAlt:
      'Pakistan Corporate Tax Calculator 2026-27 — company income tax on yearly taxable profit',
    sitemapPriority: 0.9,
    sitemapChangeFrequency: 'weekly',
  },
  '/minimum-turnover-tax-calculator': {
    ...
    description:
      'Calculate Pakistan minimum tax on turnover under Section 113 for FY 2026-27. General rate 1.25%, reduced rates by sector, and the two-year carry forward.',
    breadcrumb: 'Minimum Turnover Tax Calculator',
    appendSiteName: false,
    keywords: [
      'minimum tax calculator Pakistan',
      'minimum tax on turnover Pakistan',
      'Section 113 minimum tax calculator',
      'turnover tax calculator Pakistan 2026-27',
      '1.25% minimum tax Pakistan',
      'minimum tax rates Division IX Pakistan',
      'minimum tax loss making company Pakistan',
      'minimum tax carry forward Pakistan',
      'distributor minimum tax 0.5% Pakistan',
      'FBR minimum tax rates 2026-2027',
    ],
    datePublished: '2026-07-30',
    dateModified: '2026-07-31',
    socialImage: '/minimum-turnover-tax-calculator/opengraph-image',
    socialImageAlt:
      'Pakistan Minimum Tax on Turnover Calculator 2026-27 — the Section 113 tax floor on yearly sales',
    sitemapPriority: 0.9,
    sitemapChangeFrequency: 'weekly',
  },
  '/super-tax-calculator': {
    title: 'Super Tax Calculator Pakistan 2026-27 | Section 4C',
    description:
      'Calculate Pakistan super tax under Section 4C for FY 2026-27. Nothing up to PKR 500m and 8% above for most, 10% for banks, oil and gas and fertilizer.',
    breadcrumb: 'Super Tax Calculator',
    appendSiteName: false,
    keywords: [
      'super tax calculator Pakistan',
      'Section 4C super tax calculator',
      'super tax rate Pakistan 2026-27',
      'super tax 8% above 500 million Pakistan',
      'super tax banks 10% Pakistan',
      'super tax high income Pakistan',
      'super tax slabs 2025-26 Pakistan',
      'super tax export exemption Pakistan',
      'FBR super tax rates 2026-2027',
      'super tax on companies Pakistan',
    ],
    datePublished: '2026-07-30',
    dateModified: '2026-07-30',
    socialImage: '/super-tax-calculator/opengraph-image',
    socialImageAlt:
      'Pakistan Super Tax Calculator 2026-27 — the Section 4C extra tax on very high income',
    sitemapPriority: 0.9,
    sitemapChangeFrequency: 'weekly',
  },
  '/agricultural-income-tax-calculator': {
    title: 'Agricultural Tax Calculator Pakistan 2026-27 | All Provinces',
    description:
      'Calculate 2026-27 provincial tax on farm income in Punjab, Sindh, KP and Balochistan, including slabs, company rates and per-acre land tax.',
    breadcrumb: 'Agricultural Income Tax Calculator',
    appendSiteName: false,
    keywords: [
      'agricultural income tax calculator Pakistan',
      'agriculture tax calculator Punjab',
      'farm income tax Pakistan 2026-27',
      'Sindh agricultural income tax calculator',
      'KP agricultural income tax calculator',
      'Balochistan agricultural income tax rates',
      'agricultural income tax slabs Pakistan',
      'tax on agricultural land per acre Pakistan',
      'is agricultural income taxable in Pakistan',
      'provincial agriculture income tax rates 2025-26',
    ],
    datePublished: '2026-07-31',
    dateModified: '2026-07-31',
    socialImage: '/agricultural-income-tax-calculator/opengraph-image',
    socialImageAlt:
      'Pakistan Agricultural Income Tax Calculator 2026-27 — provincial tax on farm income',
    sitemapPriority: 0.9,
    sitemapChangeFrequency: 'weekly',
  },
  ...
  '/property-purchase-tax-calculator': {
    title: 'Property Purchase Tax Calculator Pakistan 2026-27 | 236K',
    description:
      'Calculate advance tax on buying property in Pakistan for FY 2026-27. Section 236K is 1.25% for filers and 10.5-18.5% for non-filers of the taxed value.',
    breadcrumb: 'Property Purchase Tax Calculator',
    appendSiteName: false,
    keywords: [
      'property purchase tax calculator Pakistan',
      '236K tax calculator',
      'Section 236K rate 2026-27',
      'advance tax on property purchase Pakistan',
      'buyer property tax Pakistan 2026-27',
      'non filer property purchase tax Pakistan',
      'FBR property valuation tax calculator',
      'DC rate property tax Pakistan',
      'plot purchase tax calculator Pakistan',
      'property registry tax Pakistan 2026-2027',
    ],
    datePublished: '2026-07-30',
    dateModified: '2026-07-30',
    socialImage: '/property-purchase-tax-calculator/opengraph-image',
    socialImageAlt:
      'Pakistan Property Purchase Tax Calculator 2026-27 — Section 236K advance tax for buyers',
    sitemapPriority: 0.9,
    sitemapChangeFrequency: 'weekly',
  },
  '/property-sale-tax-calculator': {
    title: 'Property Sale Tax Calculator Pakistan 2026-27 | 236C',
    description:
      'Calculate advance tax on selling property in Pakistan for FY 2026-27. Section 236C is 2.75% for filers, 11.5% for non-filers, and offsets capital gains tax.',
    breadcrumb: 'Property Sale Tax Calculator',
    appendSiteName: false,
    keywords: [
      'property sale tax calculator Pakistan',
      '236C tax calculator',
      'Section 236C rate 2026-27',
      'advance tax on property sale Pakistan',
      'seller property tax Pakistan 2026-27',
      'non filer property sale tax Pakistan',
      'property transfer tax calculator Pakistan',
      'is 236C adjustable Pakistan',
      'plot sale tax calculator Pakistan',
      'property withholding tax Pakistan 2026-2027',
    ],
    datePublished: '2026-07-30',
    dateModified: '2026-07-30',
    socialImage: '/property-sale-tax-calculator/opengraph-image',
    socialImageAlt:
      'Pakistan Property Sale Tax Calculator 2026-27 — Section 236C advance tax for sellers',
    sitemapPriority: 0.9,
    sitemapChangeFrequency: 'weekly',
  },
  '/property-capital-gains-tax-calculator': {
    title: 'Property Capital Gains Tax Calculator Pakistan 2026-27 | CGT',
    description:
      'Calculate capital gains tax on property in Pakistan for FY 2026-27. Flat 15% after 1 July 2024, holding-period rates before it, less the Section 236C credit.',
    breadcrumb: 'Property Capital Gains Tax Calculator',
    appendSiteName: false,
    keywords: [
      'capital gains tax calculator Pakistan property',
      'property CGT calculator Pakistan',
      'Section 37 capital gains property Pakistan',
      'capital gain tax on plot Pakistan',
      'property holding period tax Pakistan',
      'CGT rate property Pakistan 2026-27',
      '15% capital gains tax property Pakistan',
      'capital gains tax after 1 July 2024 Pakistan',
      'open plot capital gains tax Pakistan',
      '236C adjustable against capital gains Pakistan',
    ],
    datePublished: '2026-07-30',
    dateModified: '2026-07-30',
    socialImage: '/property-capital-gains-tax-calculator/opengraph-image',
    socialImageAlt:
      'Pakistan Property Capital Gains Tax Calculator 2026-27 — CGT on the profit from a property sale',
    sitemapPriority: 0.9,
    sitemapChangeFrequency: 'weekly',
  },
  '/cash-withdrawal-tax-calculator': {
    ...
    description:
      'Calculate Section 231AB tax on cash withdrawals in Pakistan: 0.8% for non-filers when the day’s total exceeds Rs. 50,000, and no deduction for filers.',
    breadcrumb: 'Cash Withdrawal Tax Calculator',
    appendSiteName: false,
    keywords: [
      'cash withdrawal tax calculator Pakistan',
      'tax on cash withdrawal Pakistan 2026-27',
      '231AB tax calculator',
      'Section 231AB cash withdrawal rate',
      'bank cash withdrawal tax non filer Pakistan',
      'ATM withdrawal tax Pakistan',
      '0.8% cash withdrawal tax Pakistan',
      'Rs 50000 cash withdrawal tax limit Pakistan',
      'how much tax on withdrawing cash Pakistan',
      'filer cash withdrawal tax exemption Pakistan',
    ],
    datePublished: '2026-07-30',
    dateModified: '2026-07-31',
    socialImage: '/cash-withdrawal-tax-calculator/opengraph-image',
    socialImageAlt:
      'Pakistan Cash Withdrawal Tax Calculator 2026-27 — Section 231AB tax on bank cash withdrawals',
    sitemapPriority: 0.9,
    sitemapChangeFrequency: 'weekly',
  },
  '/electricity-bill-tax-calculator': {
    ...
    description:
      'Calculate Section 235 income tax on Pakistan electricity bills for 2026-27: 7.5% on home bills from Rs. 25,000 for non-filers, plus business bands.',
    breadcrumb: 'Electricity Bill Tax Calculator',
    appendSiteName: false,
    keywords: [
      'electricity bill tax calculator Pakistan',
      'income tax on electricity bill Pakistan',
      'Section 235 tax calculator',
      'advance tax electricity consumption Pakistan 2026-27',
      'domestic electricity withholding tax Pakistan 7.5%',
      'commercial electricity bill tax Pakistan',
      'industrial electricity tax rate Pakistan',
      'Rs 25000 electricity bill tax non filer',
      'how to remove tax from electricity bill Pakistan',
      'electricity bill advance tax refund Pakistan',
    ],
    datePublished: '2026-07-30',
    dateModified: '2026-07-31',
    socialImage: '/electricity-bill-tax-calculator/opengraph-image',
    socialImageAlt:
      'Pakistan Electricity Bill Tax Calculator 2026-27 — Section 235 advance tax for homes and businesses',
    sitemapPriority: 0.9,
    sitemapChangeFrequency: 'weekly',
  },
  '/mobile-internet-tax-calculator': {
    title: 'Mobile & Internet Tax Calculator Pakistan | Section 236',
    description:
      'See the tax on a mobile load, internet or landline bill in Pakistan. Section 236 takes 15% of a load or bill, and 10% of a landline bill above Rs. 1,000.',
    breadcrumb: 'Mobile & Internet Tax Calculator',
    appendSiteName: false,
    keywords: [
      'mobile tax calculator Pakistan',
      'tax on mobile load Pakistan',
      'internet tax calculator Pakistan',
      'Section 236 tax calculator',
      'advance tax on telephone and internet Pakistan',
      'how much tax on Rs 100 load Pakistan',
      'mobile balance tax deduction Pakistan 2026-27',
      'landline bill tax Pakistan 10%',
      'prepaid card tax Pakistan 15%',
      'claim mobile tax refund Pakistan',
    ],
    datePublished: '2026-07-30',
    dateModified: '2026-07-31',
    socialImage: '/mobile-internet-tax-calculator/opengraph-image',
    socialImageAlt:
      'Pakistan Mobile & Internet Tax Calculator 2026-27 — Section 236 tax on loads and phone bills',
    sitemapPriority: 0.9,
    sitemapChangeFrequency: 'weekly',
  },
  '/capital-gains-tax-calculator': {
    title: 'Capital Gains Tax Calculator Pakistan 2026-27 | Shares & PSX',
    description:
      'Calculate tax on share profits from the Pakistan Stock Exchange. Section 37A charges 15% on shares bought from 1 July 2024, with lower rates on older holdings.',
    breadcrumb: 'Capital Gains Tax Calculator',
    appendSiteName: false,
    keywords: [
      'capital gains tax calculator Pakistan',
      'CGT calculator Pakistan shares',
      'tax on selling shares Pakistan',
      'Section 37A capital gain tax',
      'PSX capital gains tax 2026-27',
      'stock market tax calculator Pakistan',
      'NCCPL capital gain tax certificate',
      'capital gains tax rate Pakistan 15%',
      'tax on share profit Pakistan non filer',
      'holding period capital gains tax Pakistan',
      'shares bought before 2013 tax exempt Pakistan',
      'how much tax on stock profit Pakistan',
    ],
    datePublished: '2026-07-31',
    dateModified: '2026-07-31',
    socialImage: '/capital-gains-tax-calculator/opengraph-image',
    socialImageAlt:
      'Pakistan Capital Gains Tax Calculator 2026-27 — Section 37A tax on Pakistan Stock Exchange shares',
    sitemapPriority: 0.9,
    sitemapChangeFrequency: 'weekly',
  },
  '/mutual-fund-tax-calculator': {
    title: 'Mutual Fund Tax Calculator Pakistan 2026-27 | Capital Gains',
    description:
      'Work out the capital gains tax when you redeem mutual fund units in Pakistan. 15% for a person on stock and other funds, 25% for a company on other funds.',
    breadcrumb: 'Mutual Fund Tax Calculator',
    appendSiteName: false,
    keywords: [
      'mutual fund tax calculator Pakistan',
      'capital gains tax on mutual funds Pakistan',
      'stock fund tax rate Pakistan 15%',
      'other fund tax rate Pakistan 25%',
      'fund unit redemption tax calculator Pakistan',
      'mutual fund redemption tax Pakistan 2026-27',
      'AMC capital gain tax deduction Pakistan',
      'tax on mutual fund profit Pakistan non filer',
      'six year holding mutual fund tax exemption Pakistan',
      'NAV redemption tax Pakistan',
    ],
    datePublished: '2026-07-31',
    dateModified: '2026-07-31',
    socialImage: '/mutual-fund-tax-calculator/opengraph-image',
    socialImageAlt:
      'Pakistan Mutual Fund Tax Calculator 2026-27 — capital gains tax on redeeming fund units',
    sitemapPriority: 0.9,
    sitemapChangeFrequency: 'weekly',
  },
  '/vehicle-tax-calculator': {
    title: 'Vehicle Tax Calculator Pakistan 2026-27 | Section 231B',
    description:
      'Advance tax on registering or transferring a vehicle in Pakistan, FY 2026-27. Section 231B rates by engine size, filer vs non-filer, used-car reduction.',
    breadcrumb: 'Vehicle Tax Calculator',
    appendSiteName: false,
    keywords: [
      'vehicle tax calculator Pakistan',
      'car registration tax calculator Pakistan',
      '231B tax calculator',
      'Section 231B advance tax vehicle Pakistan',
      'advance tax on vehicle registration Pakistan 2026-27',
      'car transfer tax calculator Pakistan',
      'non filer car registration tax Pakistan',
      'withholding tax on motor vehicles Pakistan',
      'vehicle tax by engine capacity Pakistan',
      'imported car tax calculator Pakistan 2026-2027',
      'electric vehicle registration tax Pakistan',
      'used car transfer tax five year rule Pakistan',
    ],
    datePublished: '2026-07-30',
    dateModified: '2026-07-30',
    socialImage: '/vehicle-tax-calculator/opengraph-image',
    socialImageAlt:
      'Pakistan Vehicle Tax Calculator 2026-27 — Section 231B advance tax on registering or transferring a vehicle',
    sitemapPriority: 0.9,
    sitemapChangeFrequency: 'weekly',
  },
  '/vehicle-token-tax-calculator': {
    title: 'Token Tax Calculator Pakistan 2026-27 | All Provinces & ICT',
    description:
      'Calculate yearly vehicle token tax in Pakistan for FY 2026-27. Punjab, Sindh, KP, Balochistan and Islamabad rates, the early-payment discount and Section 234.',
    breadcrumb: 'Vehicle Token Tax Calculator',
    appendSiteName: false,
    keywords: [
      'token tax calculator Pakistan',
      'vehicle token tax calculator 2026-27',
      'Punjab token tax calculator',
      'Islamabad token tax rates 2026-27',
      'Sindh token tax rates',
      'KPK token tax rates',
      'Balochistan token tax rates',
      'annual token tax rates Pakistan private vehicles',
      'Section 234 tax on motor vehicles Pakistan',
      'token tax by engine capacity Pakistan',
      'lifetime token tax 1000cc Pakistan',
      'token tax early payment discount 31 August',
      'motor vehicle tax calculator Pakistan province',
      'car token tax invoice value percentage Punjab',
    ],
    datePublished: '2026-07-30',
    dateModified: '2026-07-30',
    socialImage: '/vehicle-token-tax-calculator/opengraph-image',
    socialImageAlt:
      'Pakistan Vehicle Token Tax Calculator 2026-27 — provincial token tax and federal Section 234',
    sitemapPriority: 0.9,
    sitemapChangeFrequency: 'weekly',
  },
  '/pta-tax-calculator': {
    title: 'PTA Tax Calculator 2026-27 | Mobile Registration Duties',
    description:
      'Calculate PTA mobile registration tax for FY 2026-27 from official FBR customs values. Passport and CNIC routes, itemised duty, sales tax and handset levy.',
    breadcrumb: 'PTA Tax Calculator',
    appendSiteName: false,
    keywords: [
      'PTA tax calculator',
      'PTA tax calculator Pakistan 2026-27',
      'mobile registration tax Pakistan',
      'DIRBS tax calculator',
      'PTA tax on iPhone Pakistan',
      'mobile phone customs duty Pakistan',
      'PTA tax passport vs CNIC',
      'mobile handset levy Pakistan',
      'phone registration tax passport Pakistan',
      'C&F value mobile phone customs Pakistan',
      'FBR mobile phone duty calculator',
      'sales tax on mobile phone import Pakistan',
      'section 148 mobile phone import tax',
      'PTA device registration duty 2026-27',
      'PTA tax list 2026-27',
      'PTA tax rates by C&F value',
      'PTA tax on iPhone 16',
      'PTA tax on Samsung Galaxy',
      'mobile phone tax Pakistan',
      'IMEI registration tax Pakistan',
      'PTA tax on used phone',
      'how to calculate PTA tax',
      'PTA tax on phone brought from abroad',
      'PSID mobile registration tax',
    ],
    datePublished: '2026-08-04',
    dateModified: '2026-08-04',
    socialImage: '/pta-tax-calculator/opengraph-image',
    socialImageAlt:
      'Pakistan PTA Mobile Registration Tax Calculator 2026-27 — FBR duties and taxes on registering an imported phone',
    sitemapPriority: 0.9,
    sitemapChangeFrequency: 'weekly',
  },
