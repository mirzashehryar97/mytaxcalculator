  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
      <div className="rounded-2xl border border-gray-200 bg-white p-4">
        ...
        <p className="mt-2 font-bold text-emerald-600 text-lg tabular-nums">
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-4">
        ...
        <p className="mt-2 font-bold text-lg text-red-600 tabular-nums">
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-4">
        ...
        <p className="mt-2 font-bold text-blue-600 text-lg tabular-nums">
