  ...
  return (
    <div className="stat-card min-w-0 border-emerald-100 bg-[#ecfdf5]">
      ...
      {showBonusChip && scenario.bonusMonthly > 0 ? (
        <p className="amount-wrap mt-5 inline-flex max-w-full flex-wrap items-center gap-1.5 rounded-lg bg-emerald-100 px-3 py-1.5 font-medium text-emerald-800 text-xs">
