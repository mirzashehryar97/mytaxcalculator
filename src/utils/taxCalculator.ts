...
export const taxSlabs: Record<string, TaxBracket[]> = {
  '2026-2027': [
    ...
    { min: 600_000, max: 1_200_000, rate: 1, fixed: 0 },
    { min: 1_200_000, max: 2_200_000, rate: 11, fixed: 6000 },
    { min: 2_200_000, max: 3_200_000, rate: 20, fixed: 116_000 },
    { min: 3_200_000, max: 4_100_000, rate: 25, fixed: 316_000 },
    { min: 4_100_000, max: 5_600_000, rate: 29, fixed: 541_000 },
    { min: 5_600_000, max: 7_000_000, rate: 32, fixed: 976_000 },
    { min: 7_000_000, max: null, rate: 35, fixed: 1_424_000 },
  ],
  '2025-2026': [
    { min: 0, max: 600_000, rate: 0, fixed: 0 },
    { min: 600_000, max: 1_200_000, rate: 1, fixed: 0 },
    { min: 1_200_000, max: 2_200_000, rate: 11, fixed: 6000 },
    { min: 2_200_000, max: 3_200_000, rate: 23, fixed: 116_000 },
    { min: 3_200_000, max: 4_100_000, rate: 30, fixed: 346_000 },
    { min: 4_100_000, max: null, rate: 35, fixed: 616_000 },
  ],
  '2024-2025': [
    { min: 0, max: 600_000, rate: 0, fixed: 0 },
    { min: 600_000, max: 1_200_000, rate: 5, fixed: 0 },
    { min: 1_200_000, max: 2_200_000, rate: 15, fixed: 30_000 },
    { min: 2_200_000, max: 3_200_000, rate: 25, fixed: 180_000 },
    { min: 3_200_000, max: 4_100_000, rate: 30, fixed: 430_000 },
    { min: 4_100_000, max: null, rate: 35, fixed: 700_000 },
  ],
  '2023-2024': [
    { min: 0, max: 600_000, rate: 0, fixed: 0 },
    { min: 600_000, max: 1_200_000, rate: 2.5, fixed: 0 },
    { min: 1_200_000, max: 2_400_000, rate: 12.5, fixed: 15_000 },
    { min: 2_400_000, max: 3_600_000, rate: 22.5, fixed: 165_000 },
    { min: 3_600_000, max: 6_000_000, rate: 27.5, fixed: 435_000 },
    { min: 6_000_000, max: null, rate: 35, fixed: 1_095_000 },
  ],
  '2022-2023': [
    { min: 0, max: 600_000, rate: 0, fixed: 0 },
    { min: 600_000, max: 1_200_000, rate: 2.5, fixed: 0 },
    { min: 1_200_000, max: 2_400_000, rate: 12.5, fixed: 15_000 },
    { min: 2_400_000, max: 3_600_000, rate: 20, fixed: 165_000 },
    { min: 3_600_000, max: 6_000_000, rate: 25, fixed: 405_000 },
    { min: 6_000_000, max: 12_000_000, rate: 32.5, fixed: 1_005_000 },
    { min: 12_000_000, max: null, rate: 35, fixed: 2_955_000 },
  ],
  '2021-2022': [
    { min: 0, max: 600_000, rate: 0, fixed: 0 },
    { min: 600_000, max: 1_200_000, rate: 5, fixed: 0 },
    { min: 1_200_000, max: 1_800_000, rate: 10, fixed: 30_000 },
    { min: 1_800_000, max: 2_500_000, rate: 15, fixed: 90_000 },
    { min: 2_500_000, max: 3_500_000, rate: 17.5, fixed: 195_000 },
    { min: 3_500_000, max: 5_000_000, rate: 20, fixed: 370_000 },
    { min: 5_000_000, max: 8_000_000, rate: 22.5, fixed: 670_000 },
    { min: 8_000_000, max: 12_000_000, rate: 25, fixed: 1_345_000 },
    { min: 12_000_000, max: 30_000_000, rate: 27.5, fixed: 2_345_000 },
    { min: 30_000_000, max: 50_000_000, rate: 30, fixed: 7_295_000 },
    { min: 50_000_000, max: 75_000_000, rate: 32.5, fixed: 13_295_000 },
    { min: 75_000_000, max: null, rate: 35, fixed: 21_420_000 },
  ],
  '2020-2021': [
    { min: 0, max: 600_000, rate: 0, fixed: 0 },
    { min: 600_000, max: 1_200_000, rate: 5, fixed: 0 },
  ...
  '2018-2019': [
    ...
    { min: 400_000, max: 800_000, rate: 0, fixed: 1000 },
    { min: 800_000, max: 1_200_000, rate: 0, fixed: 2000 },
    { min: 1_200_000, max: 2_500_000, rate: 5, fixed: 2000 },
    { min: 2_500_000, max: 4_000_000, rate: 15, fixed: 65_000 },
    { min: 4_000_000, max: 8_000_000, rate: 20, fixed: 290_000 },
    { min: 8_000_000, max: null, rate: 25, fixed: 1_090_000 },
  ],
  '2017-2018': [
    { min: 0, max: 400_000, rate: 0, fixed: 0 },
    { min: 400_000, max: 500_000, rate: 2, fixed: 0 },
    { min: 500_000, max: 750_000, rate: 5, fixed: 2000 },
    { min: 750_000, max: 1_400_000, rate: 10, fixed: 14_500 },
    { min: 1_400_000, max: 1_500_000, rate: 12.5, fixed: 79_500 },
    { min: 1_500_000, max: 1_800_000, rate: 15, fixed: 92_000 },
    { min: 1_800_000, max: 2_500_000, rate: 17.5, fixed: 137_000 },
    { min: 2_500_000, max: 3_000_000, rate: 20, fixed: 259_500 },
    { min: 3_000_000, max: 3_500_000, rate: 22.5, fixed: 359_500 },
    { min: 3_500_000, max: 4_000_000, rate: 25, fixed: 472_000 },
    { min: 4_000_000, max: 7_000_000, rate: 27.5, fixed: 597_000 },
    { min: 7_000_000, max: null, rate: 30, fixed: 1_422_000 },
  ],
  '2016-2017': [
    { min: 0, max: 400_000, rate: 0, fixed: 0 },
    { min: 400_000, max: 500_000, rate: 2, fixed: 0 },
  ...
  '2014-2015': [
    { min: 0, max: 400_000, rate: 0, fixed: 0 },
    { min: 400_000, max: 750_000, rate: 5, fixed: 0 },
    { min: 750_000, max: 1_400_000, rate: 10, fixed: 17_500 },
    { min: 1_400_000, max: 1_500_000, rate: 12.5, fixed: 82_500 },
    { min: 1_500_000, max: 1_800_000, rate: 15, fixed: 95_000 },
    { min: 1_800_000, max: 2_500_000, rate: 17.5, fixed: 140_000 },
    { min: 2_500_000, max: 3_000_000, rate: 20, fixed: 262_500 },
    { min: 3_000_000, max: 3_500_000, rate: 22.5, fixed: 362_500 },
    { min: 3_500_000, max: 4_000_000, rate: 25, fixed: 475_000 },
    { min: 4_000_000, max: 7_000_000, rate: 27.5, fixed: 600_000 },
    { min: 7_000_000, max: null, rate: 30, fixed: 1_425_000 },
  ],
};
